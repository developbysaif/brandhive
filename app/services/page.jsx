      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3">
            <Link
              href="/contact-us"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-black hover:bg-zinc-800 text-white text-xs sm:text-sm font-semibold shadow-md transition-all active:scale-[0.98]"
            >
            ...
            <Link
              href="/pricing"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white hover:bg-zinc-50 border border-zinc-200 text-zinc-800 text-xs sm:text-sm font-semibold shadow-sm transition-all active:scale-[0.98]"
            >
          ...
          {SERVICES.map((service, idx) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-[32px] sm:rounded-[40px] bg-white border border-zinc-200/90 p-6 sm:p-10 shadow-[0_8px_40px_rgba(0,0,0,0.03)] hover:border-zinc-300 transition-all"
              >
                <div className={`grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center ${isEven ? '' : 'lg:flex-row-reverse'}`}>
                  ...
                  <div className={`lg:col-span-7 space-y-6 ${isEven ? 'order-1' : 'order-1 lg:order-2'}`}>
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-mono text-[#ea580c] font-bold px-3 py-1 rounded-full bg-[#ea580c]/10">
                        0{idx + 1}
                      </span>
                    ...
                    <div className="pt-2 flex items-center gap-3">
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-black hover:bg-zinc-800 text-white text-xs font-semibold shadow-sm transition-all hover:scale-[1.02] active:scale-[0.98]"
                      >
                      ...
                      <Link
                        href="/contact-us"
                        className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-[#f4f5f7] hover:bg-zinc-100 text-zinc-800 text-xs font-semibold transition-all active:scale-[0.98]"
                      >
