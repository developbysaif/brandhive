  ...
  return (
    <div className="pt-28 md:pt-36 bg-[#fafafa]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="rounded-[32px] sm:rounded-[44px] bg-white border border-zinc-200/80 p-6 sm:p-8 md:p-10 shadow-[0_8px_40px_rgba(0,0,0,0.03)] mb-8">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 -mt-10 mb-16 flex flex-col items-center gap-4 select-none">
        <Link
          href="/contact-us"
